            ...
            <div class="container">
                ...
                <form class="form  form--auth" action="" method="post">
                    <div class="form__group  form__group--md">
                        <input class="form__control" name="reset_input_key" type="text" placeholder="Ваш код">
                        <span class="form__line"></span>
                    </div>
                    <a class="msg" style="display: block; margin-top: 2rem;" href="https://mail.google.com/mail/u/0/#inbox" target="_blank">Перейти в Gmail</a>
                    <div class="form__footer  form__footer--center">
                        <div class="form__group  form__group--md">
                            <button class="btn  btn--blue  btn--rounded  btn--sm" type="submit" id="try-reset-btn">Відновити</button>
                        </div>
